    ...
    <Navbar fixed="top" expand="lg" bg="dark" variant="dark">
      <Container>
        ...
        >
          ...
          {
            user.rol === "Estudiante"? (
              <NavDropdown.Item href="/studentProjects">
                <img src="https://img.icons8.com/material-outlined/30/000000/project.png"/>{" "}
                Mis proyectos
              </NavDropdown.Item>
            ) : user.rol === 'Admin'? (
              <NavDropdown.Item href="/studentProjects">
                <img src="https://img.icons8.com/material-outlined/30/000000/project.png"/>{" "}
                Vista proyectos estudiantes
              </NavDropdown.Item>
            ) : null
          }
          {
            user.rol === "Lider"? (
              <NavDropdown.Item href="/leaderProjects">
                <img src="https://img.icons8.com/material-outlined/30/000000/project-setup.png"/>{" "}
                Mis proyectos
              </NavDropdown.Item>
            ) : user.rol === 'Admin'? (
              <NavDropdown.Item href="/leaderProjects">
                <img src="https://img.icons8.com/material-outlined/30/000000/project-setup.png"/>{" "}
                Vista proyectos lider
              </NavDropdown.Item>
            ) : null
          }
            <NavDropdown.Divider />
