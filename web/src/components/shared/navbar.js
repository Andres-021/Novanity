...
import {BrowserRouter as Router, Routes, Route, Navigat, useNavigate} from 'react-router-dom';
import {
  Nav,
  Navbar,
  NavDropdown,
      ...
      <Container>
        ...
        <Nav className="justify-content-center" justify variant="pills" defaultActiveKey="/">
          ...
          <OverlayTrigger
            placement='bottom'
            overlay={
              <Tooltip id={'bottom'}>Inicio</Tooltip>
            }
          >
            {/* Ruta home */}
            <Nav.Link href="/">
          ...
          {}
            <OverlayTrigger
              placement='bottom'
              overlay={
                <Tooltip id={'bottom'}>Proyectos</Tooltip>
              }
            >
              {/* Ruta proyectos */}
           ...
           // la gestion de usuarios, de lo contrario no sera vista 
            user.rol === 'Admin'
              ?  <OverlayTrigger
                  placement='bottom'
                  overlay={
                    <Tooltip id={'bottom'}>Usuarios</Tooltip>
                  }
                >
                  {/* Ruta proyectos */}
                  <Nav.Link href="/#users">
          ...
          <NavDropdown title={<img src="https://img.icons8.com/material-outlined/32/ffffff/sorting-options.png"/>} id="collasible-nav-dropdown">
            <NavDropdown.Item href="/#profile">
              <img src="https://img.icons8.com/material-outlined/30/000000/user.png"/> Perfil
            </NavDropdown.Item>
            <NavDropdown.Divider />
            <NavDropdown.Item onClick={logout}>
              <img src="https://img.icons8.com/material-outlined/30/000000/exit.png"/> Salir
            </NavDropdown.Item>
          </NavDropdown>
        </Nav>
      </Container>
